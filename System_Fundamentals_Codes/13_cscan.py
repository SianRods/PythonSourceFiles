# The only difference between scan and scan is the 
# lower_bound list must not be in the reverse sroted order 
# current head = first_track before entering the lower_bound list 
# additional_track movement of last_track-first_track
...
def cscan(current_head,reference_string,total_tracks):
    ...
    track_movement+=last_track-first_track

    current_head=first_track
...
total_tracks=200
print("Total Track Movement is : ",cscan(50,reference_list,total_tracks))